...
The next decade was much tougher on me. I ran a one-person LLC, which I'm glad I did, but it turned out to be a failed experiment. I also did data and DevOps engineering, which started to open my eyes to how some of the problems holding back progress in security could be solved with a platform engineering approach -- which is now, _after a friendly shove from COVID_, what I spend my working hours trying to figure out.
